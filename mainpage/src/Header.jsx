...
function Header() {
  return (
    ...
    >
      <Container>
        <Navbar.Brand href="http://localhost:3000" style={{fontSize:"36px", fontWeight:"bold"}}>Barrister</Navbar.Brand>
        <NavDropdown title={<List color="white" size={36} className="align-top"/>} id="basic-nav-dropdown">
              <NavDropdown.Item href="http://localhost:3005"><JournalText /> Recipe Book</NavDropdown.Item>
